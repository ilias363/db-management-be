...
public class ValidStandardColumnDefaultValidator implements ConstraintValidator<ValidColumnDefault, NewStandardColumnDto> {
    ...
    public boolean isValid(NewStandardColumnDto dto, ConstraintValidatorContext context) {
        ...
        if (defaultValue == null || defaultValue.trim().isEmpty()) return true;
