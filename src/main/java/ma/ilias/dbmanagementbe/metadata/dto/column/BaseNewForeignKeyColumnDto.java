...
public abstract class BaseNewForeignKeyColumnDto extends BaseNewColumnDto implements IReferencedColumnReference {
	...
	@Pattern(regexp = "^(?i)(CASCADE|NO ACTION|RESTRICT|SET NULL|SET DEFAULT)$", message = "Delete action is not valid")
	private String onDeleteAction;

	@Pattern(regexp = "^(?i)(CASCADE|NO ACTION|RESTRICT|SET NULL|SET DEFAULT)$", message = "Update action is not valid")
